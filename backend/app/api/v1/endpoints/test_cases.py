...
def get_test_cases_by_file(file_id: str = Path(..., description="File ID")):
    """Get all test cases for a file, grouped by requirement"""
    try:
        return database_service.get_test_cases_by_file(file_id)
    except Exception as e:
